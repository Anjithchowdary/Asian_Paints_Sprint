...
import com.pagefactory.ShopOption_pagefactory;
...
public class Shop_catalouge {
	WebDriver driver;
	ShopOption_pagefactory aj;
...
public void user_clicks_on_profile_button() {
	aj=new ShopOption_pagefactory(driver);
	aj=PageFactory.initElements(driver, ShopOption_pagefactory.class);
    aj.profilebutton();
}
